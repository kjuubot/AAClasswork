...
ActiveRecord::Schema.define(version: 2020_01_24_001407) do
  ...
  create_table "artwork_shares", force: :cascade do |t|
    ...
    t.boolean "fav_shared_art", default: false
  ...
  create_table "artworks", force: :cascade do |t|
    ...
    t.string "image_url"
    t.integer "artist_id"
    t.boolean "fav_own_art", default: false
  ...
  create_table "collections", force: :cascade do |t|
    ...
    t.index ["artwork_id", "collection_id"], name: "index_collections_on_artwork_id_and_collection_id", unique: true
  end
